...
4. Hide the unwanted stock status icons with [Essentials](https://github.com/sameerasw/essentials), then tune count, spacing, size, inset, and icon color in this app.
